...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // 同时发送两个请求
    axios
        .all([postContact, getHealth])
        .then(
            axios.spread((postResponse, getResponse) => {
              // POST /contact 成功
              setLoading(false);
              ...
              // GET /health 成功
              console.log("Health Check Success:", getResponse.data);
            })
        )
        .catch((error) => {
          // 处理任何一个请求的错误
          ...
          alert(
              error.response?.data?.error || "Ahh, something went wrong. Please try again."
          );
        });
  };
